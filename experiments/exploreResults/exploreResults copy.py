...
def printEdge(edge):
    ...
    textDate1 = user1Data[user1Data.tweet_type!="retweet"]["text"] + " (" + user1Data["creation_date"] + ")"
    textDate2 = user2Data[user2Data.tweet_type!="retweet"]["text"] + " (" + user2Data["creation_date"] + ")"
    ...
    print("\t\t Shared RTs by User1:", len(retweets1shared))
    print("\t\t Shared RTs by User2:", len(retweets2shared))
