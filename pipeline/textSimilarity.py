...
#        'imageUrls', 'segments', 'author', 'text', 'geolocation', 'id',
#        'language', 'mediaType', 'mediaTypeAttributes', 'mentionedUsers',
#        'name', 'creation_date', 'title', 'url', 'translatedtext',
#        'translatedTitle','tweet_type','tweet_id'],
#       dtype='object'

# Mandatory Fields
# 1. tweet_text
# ['user_id' --> numerical encoding of author]
